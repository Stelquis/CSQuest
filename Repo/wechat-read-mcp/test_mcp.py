...
BINARY = "/workspace/Repo/wechat-read-mcp/target/release/weixin-mcp-rs"
URL = "https://mp.weixin.qq.com/s/uQlo1GCvS14O-l7hH0qzfg"
...
proc = subprocess.Popen(
    ...
    env={**os.environ, "CHROME_PATH": "/usr/bin/google-chrome-stable"},
    text=True,
...
print("   ⏳ Chrome rendering article, please wait ...")
sys.stdout.flush()

resp = read_msg(proc, timeout=120)
if not resp:
